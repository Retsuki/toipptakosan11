...
(function(exports) {
 ...
 ${JSON.stringify(location2)}${currentLocation ? "\nwhile being at\n" + JSON.stringify(currentLocation) : ""}`;
  ...
  const RouterLinkImpl = /* @__PURE__ */ vue.defineComponent({
    ...
    useLink,
    setup(props, { slots }) {
      const link2 = vue.reactive(useLink(props));
...
var createElement = (tag2, attrs, document2) => {
  const el = document2.createElement(tag2);
...
var headObjToTags = (obj) => {
  ...
  for (const key of Object.keys(obj)) {
    if (obj[key] == null)
      continue;
    if (key === "title") {
      tags2.push({ tag: key, props: { children: obj[key] } });
    } else if (key === "base") {
      tags2.push({ tag: key, props: __spreadValues2({ key: "default" }, obj[key]) });
    } else if (acceptFields.includes(key)) {
      const value = obj[key];
      if (Array.isArray(value)) {
        value.forEach((item) => {
          tags2.push({ tag: key, props: item });
        });
      } else if (value) {
        tags2.push({ tag: key, props: value });
      }
    }
  }
  return tags2;
...
var insertTags = (tags2, document2 = window.document) => {
  ...
  for (const tag2 of tags2) {
    if (tag2.tag === "title") {
      title = tag2.props.children;
      continue;
    }
    if (tag2.tag === "htmlAttrs") {
      Object.assign(htmlAttrs, tag2.props);
      continue;
    }
    if (tag2.tag === "bodyAttrs") {
      Object.assign(bodyAttrs, tag2.props);
      continue;
    }
    if (tag2.tag === "meta") {
      const key = getTagKey(tag2.props);
      if (key) {
        const elementList = [
    ...
    newElements.push(createElement(tag2.tag, tag2.props, document2));
  }
  ...
  const head = {
    ...
    get headTags() {
      ...
      allHeadObjs.forEach((objs) => {
        const tags2 = headObjToTags(objs.value);
        tags2.forEach((tag2) => {
          if (tag2.tag === "meta" || tag2.tag === "base") {
            const key = getTagKey(tag2.props);
            if (key) {
              let index2 = -1;
              for (let i = 0; i < deduped.length; i++) {
                ...
                const nextValue = tag2.props[key.name];
                if (prev.tag === tag2.tag && prevValue === nextValue) {
                  index2 = i;
                  break;
                }
              }
...
var tagToString = (tag2) => {
  let attrs = stringifyAttrs(tag2.props);
  if (SELF_CLOSING_TAGS.includes(tag2.tag)) {
    return `<${tag2.tag}${attrs}>`;
  }
  return `<${tag2.tag}${attrs}>${tag2.props.children || ""}</${tag2.tag}>`;
};
var renderHeadToString = (head) => {
  ...
  let htmlAttrs = {};
  let bodyAttrs = {};
  for (const tag2 of head.headTags) {
    if (tag2.tag === "title") {
      titleTag = tagToString(tag2);
    } else if (tag2.tag === "htmlAttrs") {
      Object.assign(htmlAttrs, tag2.props);
    } else if (tag2.tag === "bodyAttrs") {
      Object.assign(bodyAttrs, tag2.props);
    } else {
      tags2.push(tagToString(tag2));
    }
  }
  tags2.push(`<meta name="${HEAD_COUNT_KEY}" content="${tags2.length}">`);
  return {
    get headTags() {
      return titleTag + tags2.join("");
    },
    get htmlAttrs() {
...
const vueuseHead_8d5ca3a8 = defineNuxtPlugin((nuxt) => {
...
const plugin_3fa13e20 = defineNuxtPlugin((nuxt) => {
  ...
  for (const name2 in Components) {
    nuxt.app.component(name2, Components[name2]);
  }
});
const layouts = {};
...
const NuxtPage = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$b]]);
const routes = [
  {
    "name": "index",
    "path": "/",
  ...
  },
  {
    ...
    "children": [],
    "component": () => Promise.resolve().then(function() {
      return memberDetail$1;
    })
  }
];
const router_4ff068ff = defineNuxtPlugin((nuxt) => {
  const { app } = nuxt;
...
function setHeader(options, _key, value) {
  ...
  if ("set" in options.headers) {
    ...
    const existingHeader = options.headers.find(([header2]) => header2.toLowerCase() === key);
    if (existingHeader) {
    ...
    const existingHeader = Object.keys(options.headers).find((header2) => header2.toLowerCase() === key);
...
const nitroClient_8089e144 = () => {
};
const components = {
  "OrganismsGlobalFooter": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return GlobalFooter;
  }).then((c) => c.default || c)),
  "OrganismsGlobalHeader": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return GlobalHeader;
  }).then((c) => c.default || c)),
  "OrganismsMemberDetailExperience": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return MemberDetailExperience;
  }).then((c) => c.default || c)),
  "OrganismsMemberDetailSelfIntroduction": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return MemberDetailSelfIntroduction;
  }).then((c) => c.default || c)),
  "OrganismsMemberDetailSkills": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return MemberDetailSkills;
  }).then((c) => c.default || c))
};
function components_515c5644(nuxt) {
  for (const name2 in components) {
    nuxt.app.component(name2, components[name2]);
    nuxt.app.component("Lazy" + name2, components[name2]);
  }
}
const _plugins = [
  preload,
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$a]]);
const wrapper$8 = "_wrapper_1s36t_1";
const headerContents = "_headerContents_1s36t_7";
const logo = "_logo_1s36t_18";
const rightContents$2 = "_rightContents_1s36t_24";
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))}><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.headerContents)}">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_router_link, {
    ...
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          vue_cjs_prod.createTextVNode("R - World")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`<div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.rightContents)}"><ul class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.list)}"><li>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_router_link, {
    to: "/",
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_router_link, {
    ...
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          vue_cjs_prod.createTextVNode("member")
        ];
      }
    }),
    _: 1
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$9], ["__cssModules", cssModules$9]]);
const GlobalHeader = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": __nuxt_component_0$1
});
const wrapper$7 = "_wrapper_197sn_1";
const style0$8 = {
  wrapper: wrapper$7
};
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$8], ["__cssModules", cssModules$8]]);
const GlobalFooter = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs) {
  const _component_organisms_global_header = __nuxt_component_0$1;
  const _component_NuxtPage = vue_cjs_prod.resolveComponent("NuxtPage");
  const _component_organisms_global_footer = __nuxt_component_1$1;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_organisms_global_header, null, null, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtPage, {
    class: _ctx.$style.mainContents
  }, null, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_organisms_global_footer, null, null, _parent));
  _push(`</div>`);
}
const cssModules$7 = {};
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7], ["__cssModules", cssModules$7]]);
let entry;
...
const wrapper$6 = "_wrapper_o0koy_1";
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<main${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    class: _ctx.$style.wrapper
  }, _attrs))}><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.hello)}"><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.container)}"><h1>R - World</h1><p>Let them draw big dreams. Make big dreams come true.</p></div></div><section class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.section)}"><h2>Mission</h2><p>\u6311\u6226\u8005\u306B\u81EA\u7531\u3067\u5927\u304D\u306A\u5922\u3092\u63CF\u304B\u305B\u3001\u305D\u308C\u3092\u5B9F\u73FE\u3055\u305B\u308B</p><h3>Organization</h3><p>R\u3061\u3083\u3093\u304C\u51FA\u4F1A\u3063\u3066\u304D\u305F\u6109\u5FEB\u306A\u66F2\u8005\u305F\u3061\u306E\u96C6\u307E\u308A</p></section></main>`);
}
const cssModules$6 = {};
...
const index$2 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__cssModules", cssModules$6]]);
const index$3 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": index$2
});
const _imports_0 = "/_nuxt/assets/facebook-brands.e4e4ffee.svg";
const _imports_1 = "/_nuxt/assets/twitter-brands.dd81ac6e.svg";
const _imports_2 = "/_nuxt/assets/github-brands.4ea99f48.svg";
const wrapper$5 = "_wrapper_l366w_1";
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    class: _ctx.$style.wrapper
  }, _attrs))}><div>Self Introduction</div><p>${serverRenderer.exports.ssrInterpolate(_ctx.member.self_introduction)}</p><ul class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.sns)}">`);
  if (_ctx.member.sns.facebook) {
    _push(`<li><a${serverRenderer.exports.ssrRenderAttr("href", _ctx.member.sns.facebook)}><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="facebook icon" class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.icon)}"></a></li>`);
  } else {
    _push(`<!---->`);
  }
  if (_ctx.member.sns.twitter) {
    _push(`<li><a${serverRenderer.exports.ssrRenderAttr("href", _ctx.member.sns.twitter)}><img${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} alt="twitter icon" class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.icon)}"></a></li>`);
  } else {
    _push(`<!---->`);
  }
  if (_ctx.member.sns.github) {
    _push(`<li><a${serverRenderer.exports.ssrRenderAttr("href", _ctx.member.sns.github)}><img${serverRenderer.exports.ssrRenderAttr("src", _imports_2)} alt="github icon" class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.icon)}"></a></li>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</ul></section>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__cssModules", cssModules$5]]);
const MemberDetailSelfIntroduction = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": __nuxt_component_0
});
const wrapper$4 = "_wrapper_1jxxg_1";
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    class: _ctx.$style.wrapper
  }, _attrs))}><div>Experience</div><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.contents)}"><ul><!--[-->`);
  serverRenderer.exports.ssrRenderList(_ctx.member.experience, ({ company, describe, occupation, skills }) => {
    _push(`<li><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.point)}"></div><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.cardBox)}"><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.cardContents)}"><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.companyName)}">${serverRenderer.exports.ssrInterpolate(company)}</div><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.companyPosition)}">${serverRenderer.exports.ssrInterpolate(occupation[0])}</div><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.companyDescription)}">${serverRenderer.exports.ssrInterpolate(describe)}</div><ul class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.companySkills)}"><!--[-->`);
    serverRenderer.exports.ssrRenderList(skills, (skill) => {
      _push(`<li><span>${serverRenderer.exports.ssrInterpolate(skill)}</span></li>`);
    });
    _push(`<!--]--></ul></div></div></li>`);
  });
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__cssModules", cssModules$4]]);
const MemberDetailExperience = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": __nuxt_component_1
});
const wrapper$3 = "_wrapper_542nc_1";
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    class: _ctx.$style.wrapper
  }, _attrs))}><div>Skills</div><ul class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.tags)}"><!--[-->`);
  serverRenderer.exports.ssrRenderList(_ctx.skills, (skill) => {
    _push(`<li><span class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.tag)}">${serverRenderer.exports.ssrInterpolate(skill)}</span></li>`);
  });
  _push(`<!--]--></ul></div>`);
}
const cssModules$3 = {};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__cssModules", cssModules$3]]);
const MemberDetailSkills = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
...
function useMembers() {
  ...
  const members = vue_cjs_prod.ref([]);
...
const wrapper$2 = "_wrapper_1kh5r_1";
const header$1 = "_header_1kh5r_7";
const headerContent$1 = "_headerContent_1kh5r_16";
const rightContents$1 = "_rightContents_1kh5r_32";
const main$1 = "_main_1kh5r_44";
const style0$2 = {
  wrapper: wrapper$2,
  header: header$1,
  headerContent: headerContent$1,
  rightContents: rightContents$1,
  main: main$1
};
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_organisms_member_detail_self_introduction = __nuxt_component_0;
  const _component_organisms_member_detail_experience = __nuxt_component_1;
  const _component_organisms_member_detail_skills = __nuxt_component_2;
  if (_ctx.member) {
    _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
      class: _ctx.$style.wrapper
    }, _attrs))}><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.header)}"><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.headerContent)}"><img${serverRenderer.exports.ssrRenderAttr("src", _ctx.member.profile_image.url)} alt="profile image"><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.rightContents)}"><h3>${serverRenderer.exports.ssrInterpolate(_ctx.member.name)}</h3><div>${serverRenderer.exports.ssrInterpolate(_ctx.member.company)} / ${serverRenderer.exports.ssrInterpolate(_ctx.member.occupation[0])}</div><div>ID: ${serverRenderer.exports.ssrInterpolate(_ctx.member.id)}</div></div></div></div><main class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.main)}">`);
    _push(serverRenderer.exports.ssrRenderComponent(_component_organisms_member_detail_self_introduction, { member: _ctx.member }, null, _parent));
    _push(serverRenderer.exports.ssrRenderComponent(_component_organisms_member_detail_experience, { member: _ctx.member }, null, _parent));
    _push(serverRenderer.exports.ssrRenderComponent(_component_organisms_member_detail_skills, {
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__cssModules", cssModules$2]]);
const _id_$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": _id_
});
const wrapper$1 = "_wrapper_1kexk_1";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  serverRenderer.exports.ssrRenderList(_ctx.members, ({ id, updatedAt, name: name2, occupation, company, experience_year, profile_image }) => {
    _push(`<li class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.card)}">`);
    _push(serverRenderer.exports.ssrRenderComponent(_component_router_link, {
      to: `/member/${id}`,
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", profile_image.url)} class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.profileImage)}"${_scopeId}><div${_scopeId}><div class="${serverRenderer.exports.ssrRenderClass(_ctx.$style.name)}"${_scopeId}>${serverRenderer.exports.ssrInterpolate(name2)}</div><ul${_scopeId}><li${_scopeId}>\u8077\u7A2E: ${serverRenderer.exports.ssrInterpolate(occupation[0])}</li><li${_scopeId}>\u7D4C\u9A13\u5E74\u6570: ${serverRenderer.exports.ssrInterpolate(experience_year)}\u5E74</li><li${_scopeId}>\u52E4\u52D9\u5148: ${serverRenderer.exports.ssrInterpolate(company)}</li><li${_scopeId}>\u6700\u7D42\u66F4\u65B0\u65E5: ${serverRenderer.exports.ssrInterpolate(updatedAt)}</li></ul></div>`);
        } else {
          return [
            ...
            vue_cjs_prod.createVNode("div", null, [
              ...
              }, vue_cjs_prod.toDisplayString(name2), 3),
              vue_cjs_prod.createVNode("ul", null, [
                vue_cjs_prod.createVNode("li", null, "\u8077\u7A2E: " + vue_cjs_prod.toDisplayString(occupation[0]), 1),
                vue_cjs_prod.createVNode("li", null, "\u7D4C\u9A13\u5E74\u6570: " + vue_cjs_prod.toDisplayString(experience_year) + "\u5E74", 1),
                vue_cjs_prod.createVNode("li", null, "\u52E4\u52D9\u5148: " + vue_cjs_prod.toDisplayString(company), 1),
                vue_cjs_prod.createVNode("li", null, "\u6700\u7D42\u66F4\u65B0\u65E5: " + vue_cjs_prod.toDisplayString(updatedAt), 1)
              ])
            ])
          ];
        }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__cssModules", cssModules$1]]);
...
const memberDetail = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__cssModules", cssModules]]);
const memberDetail$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
